...
-- DetallesFacturaVentasMedicamento (medicamentos for 60 facturas)
-- Distribution: 40 facturas with only medicamentos + 20 facturas with both
-- codCobertura only if the cliente has cobertura
-- Only medicamentos with stock in that sucursal
...
(1, 450.00, NULL, 16, 16),
(2, 380.00, NULL, 47, 17),
(1, 1250.00, NULL, 39, 17),
(2, 680.00, NULL, 25, 18),
(1, 1250.00, NULL, 10, 18),
(1, 680.00, NULL, 31, 20),
(1, 380.00, NULL, 47, 20),
(1, 1250.00, 1, 39, 21),
(1, 680.00, 1, 31, 21),
(1, 380.00, NULL, 47, 23),
(2, 1250.00, NULL, 10, 23),
(2, 1200.00, 7, 1, 27),
(2, 380.00, 7, 6, 27),
(1, 3500.00, 8, 2, 28),
(2, 450.00, 9, 4, 30),
...
(2, 720.00, NULL, 19, 74),
(2, 520.00, NULL, 32, 74),
(2, 1150.00, NULL, 11, 75),
(1, 890.00, NULL, 15, 75),
(1, 1450.00, NULL, 40, 76),
(2, 620.00, NULL, 5, 77),
(1, 1450.00, NULL, 40, 77),
(1, 1150.00, NULL, 36, 79),
(1, 520.00, NULL, 7, 80),
(1, 680.00, 1, 25, 81),
(1, 880.00, 4, 37, 84),
(2, 680.00, 5, 25, 85),
(1, 620.00, NULL, 5, 86),
(2, 1200.00, NULL, 21, 86),
(2, 450.00, 8, 4, 88),
(2, 1250.00, 8, 10, 88),
(2, 1200.00, NULL, 1, 89),
(1, 3500.00, NULL, 2, 91),
(1, 450.00, 10, 4, 92),
(1, 1200.00, 10, 21, 92),
(2, 1250.00, NULL, 10, 93),
(2, 450.00, NULL, 4, 93),
(2, 680.00, NULL, 31, 95),
(2, 450.00, NULL, 4, 98),
(1, 3500.00, NULL, 2, 100);

-- DetallesFacturaVentasArticulo (articulos for 60 facturas)
-- Distribution: 40 facturas with only articulos + 20 facturas with both
-- Only articulos with stock in that sucursal
